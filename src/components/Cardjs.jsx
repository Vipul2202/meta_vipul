...
<p className='font-bold font-serif flex justify-center text-2xl py-4 text-white'>Escape the reality by jumping into the modern era of Virtual Land in 7 Different heart-breathing categories.
</p></div>
